...
def setstate(sensorname,temperature):
    ...
    response = requests.post(rootstates+sensorname, headers=headers, data=data)

names = {'01192789f2e7': 'Boiler Out',
         '0119277223c1': 'Return Flow',
         '00000a71a6f4': 'Garage',
         '011927b884ad': 'Outside',
         '0119278a76fa': 'Central Heating',
         '011927dba794': 'Primary Flow In',
         '0119278a153a': 'Office',
         '011927886302': 'Loft',
         '0119276ac068': 'Hot Water',
         '011927dc2d4e': 'Mains Cold',
         '011927dd1fad': 'Top of Tank'}
headers = {
    "Authorization": "Bearer REPLACE-WITH-YOU-TOKEN",
...
#        if sensor_path.split('/')[5][-12:] == '011927886302': # loft
#            loft_temp = temp_c
#        elif sensor_path.split('/')[5][-12:] == '0119278a153a': # office
#            office_temp = temp_c
#
#    with open(root_dir+'bats.txt', 'w') as w:
#        w.write('{:.1f},{:.1f}'.format(office_temp,loft_temp))
